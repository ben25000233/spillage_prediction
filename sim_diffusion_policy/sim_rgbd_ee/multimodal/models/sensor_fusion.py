...
class SensorFusion(nn.Module):
    ...
    def __init__(
        ...
        # self.pre_pcd_encoder = pred_pcd_Encoder(device = device)
    ...
    def forward_encoder(self, ee_pose, front_pcd, ee_pcd, flow_pcd):
        ...
        # ee_pcd_out_2 = self.obs_pcd_encoder.encode(see_pcd[:, -1, :, :])
...
class Dynamics_model(SensorFusion):
    ...
    def __init__(
        ...
        # LSTM layer
        self.lstm = nn.LSTM(input_size=736, hidden_size=512, num_layers=num_layers, batch_first=True)
